...
keys = ['id', 'guidislink', 'link', 'title', 'title_detail', 'published', 'published_parsed', 'links', 'authors', 'author', 'author_detail', 'dcterms_alternative', 'summary', 'summary_detail', 'tags', 'media_keywords', 'media_content', 'media_thumbnail', 'href', 'content']
